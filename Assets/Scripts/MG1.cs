...
public class MG1 : MonoBehaviour
{
    ...
    public InputField DesviacionInput;
    ...
    public void generarNumeros()
    {
        ...
        desviacion = double.Parse(DesviacionInput.text);
        ...
        }else if (lambda < 0 || miu < 0 || desviacion < 0 )
        {
        ...
        else
        {
            ...
            DesviacionInput.interactable = false;
    ...
    public double generarL(double p, double lq)
    {
        // resetTable();
        //Recibir los input
